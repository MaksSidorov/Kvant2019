...
class Table(QWidget):
    ...
    def initUI(self):
        ...
        self.tableWidget.setHorizontalHeaderLabels(
            ('дата', 'Упражнение № 1', 'Упражнение № 2', 'Упражнение № 3(Правый глаз)', 'Упражнение № 3(Левый глаз)',
             'Упражнение № 4(Правая сторона)', 'Упражнение № 4(Левая сторона)', 'Упражнение № 5(Правая сторона)',
             'Упражнение № 5(Левая сторона)','злость', 'отвращение', 'страх', 'радость', 'грусть', 'удивление')
        )
